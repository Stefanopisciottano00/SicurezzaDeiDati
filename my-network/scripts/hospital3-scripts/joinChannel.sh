...
joinChannel() {
  ...
  while [ $rc -ne 0 -a $COUNTER -lt $MAX_RETRY ] ; do
	...
	cat log.txt
	verifyResult $res "After $MAX_RETRY attempts, peer0.hospita${ORG} has failed to join channel '$CHANNEL_NAME' "
}
...
infoln "Joining hospital3 peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for hospital3..."
setAnchorPeer 3
